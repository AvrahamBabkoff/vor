...
public class Main 
{
	...
	//private static final MyShutdown m_sd = new MyShutdown ();
...
*/
	...
	private static int getPort()
	{
		...
		{
			_logger.log(Level.SEVERE, "service name is " + sServiceName);
			...
			{
				_logger.log(Level.SEVERE, "sJSON is null!!!");
			}
			if (null != jsonRes)
			{
				...
				{
					_logger.log(Level.SEVERE, "iResult is " + iResult);
					String _msg = ((JSONObject)jsonRes.get("Meta")).getString("message");
					_logger.log(Level.SEVERE, "message is " + _msg);
				}
			}
			else
			{
				_logger.log(Level.SEVERE, "jsonRes is null!!!");
			}
		}
		else
		{
			_logger.log(Level.SEVERE, "sServiceName is null!!!");
		}
		return iPort;
	}
    public static void main(String[] args) throws IOException 
    {
    	...
    	else
    	{
    		...
    		NetServer.InitNetServer(Constants.NET_VOS_DAL_CONFIG_ROOT_URI, iPort, Constants.NET_VOS_DAL_CONFIG_API_ROOT_PACKAGE_NAME, msd);
    	}
